...
type TagPageQuery = { readonly allMdx: { readonly edges: ReadonlyArray<{ readonly node: { readonly excerpt: string | null, readonly frontmatter: { readonly date: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly title: string | null } | null, readonly parent: { readonly name: string } | {} | null } }> } };
